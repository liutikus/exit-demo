...
const TradeInHero = () => {
  return (
    ...
    <div className="flex flex-col gap-y-6 items-center ">
        <div className="flex flex-col gap-y-8 items-center w-[60%] text-center p-15">
        ...
        <h2 className="text-4xl font-bold">Faceți schimb. Upgrade. Economisește. Sau reciclează-l gratuit.</h2>
        <p className="opacity-30">Vizitează site-ul nostru sau vino într-un magazin EXIT Service pentru a evalua starea iPhone-ului tău. Oferă detalii precum modelul, capacitatea de stocare și eventualele daune vizibile. </p>
        <p className="opacity-30">Vei primi instant o estimare preliminară a valorii dispozitivului tău.</p>
